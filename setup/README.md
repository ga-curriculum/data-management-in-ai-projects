...
1. **Create a Directory**
   - On your machine, create a directory or folder named `data-management-in-ai-projects` where you can save all the data and the jupyter notebooks concerned with this module.
...
4. **Create a New Jupyter Notebook**  
   ...
   - Rename the notebook by clicking on the **default name ("Untitled")** and entering the name as:  
     ```
     <DATA_MANAGEMENT_IN_AI_PROJECTS>.ipynb
     ```
